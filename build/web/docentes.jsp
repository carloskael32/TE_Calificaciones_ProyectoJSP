            ...
            <table class="table table-striped">
                ...
                <c:forEach var="item" items="${docentes}">
                    <tr>
                        ...
                        <td>${item.telefono}</td>
                        <td>${item.correo}</td>
                        <td><a href="DocenteControlador?action=edit&id_docente=${item.id_docente}"><i class="fas fa-edit"></i></a></td>
                        <td><a href="DocenteControlador?action=delete&id_docente=${item.id_docente}" onclick="return(confirm('Esta seguro ???'))">
